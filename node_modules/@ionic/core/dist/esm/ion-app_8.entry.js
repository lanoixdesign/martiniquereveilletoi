import { r as registerInstance, h, H as Host, i as getElement, e as createEvent, f as readTask, j as forceUpdate, c as writeTask } from './index-e806d1f6.js';
import { b as getIonMode, c as config, i as isPlatform } from './ionic-global-9d5c8ee3.js';
import { e as clamp } from './helpers-002e4980.js';
import { t as transition } from './index-35146240.js';
  ...
  componentDidLoad() {
    {
      rIC(() => {
        ...
        if (!config.getBoolean('_testing')) {
          import('./tap-click-9f8fd111.js').then(module => module.startTapClick(config));
        }
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-b46a1b02.js').then(module => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          import('./input-shims-7574994a.js').then(module => module.startInputShims(config));
        }
        if (config.getBoolean('hardwareBackButton', isHybrid)) {
          import('./hardware-back-button-389954a0.js').then(module => module.startHardwareBackButton());
        }
...
const RouterOutlet = class {
  ...
  async connectedCallback() {
    this.gesture = (await import('./swipe-back-53c5a7dd.js')).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
