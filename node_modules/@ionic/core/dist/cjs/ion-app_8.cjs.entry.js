...
const helpers = require('./helpers-2a34b846.js');
const index$1 = require('./index-2b6284dc.js');
  ...
  componentDidLoad() {
    {
      rIC(() => {
        ...
        if (!ionicGlobal.config.getBoolean('_testing')) {
          Promise.resolve().then(function () { return require('./tap-click-181f300f.js'); }).then(module => module.startTapClick(ionicGlobal.config));
        }
        ...
        if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
          Promise.resolve().then(function () { return require('./input-shims-bf91f7a1.js'); }).then(module => module.startInputShims(ionicGlobal.config));
        }
...
const RouterOutlet = class {
  ...
  async connectedCallback() {
    this.gesture = (await Promise.resolve().then(function () { return require('./swipe-back-3fe75955.js'); })).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
